    ...
    return ( 
        ...
        <Container>
            ...
            <div className={styles.containerHead}>
                <Typography variant="h4" className={styles.aboutTxt}>/about</Typography>
            </div>
            <div className={styles.containerBody}>
                ...
                <div className={styles.aboutme}>
                    <Typography variant="subtitle" className={styles.aboutBodyTxt}>
                        ...
                        In my free time I am also a graphics designer and I indulge in some forms of video editing.
                        <br/><br/>
                        <Typography variant="subtitle">
                            Currently, I work as a freelancer. This certainly shows how much I love remote jobs.
                        </Typography>
                    </Typography>
