      ...
      <AppBar position="static" className={styles.appbar}>
        <Toolbar>
          <ButtonGroup variant="text" className={styles.buttonGroup}>
            <Button onClick={goToHome} className={styles.btn}>
              <HomeIcon className={styles.menuIcon} /> Home
            </Button>
            <Button onClick={goToBlog} className={styles.btn}>
              <NewspaperIcon className={styles.menuIcon} /> Blog
            </Button>
          </ButtonGroup>
        </Toolbar>
      </AppBar>
